...
function LoginAndUnlockTheSecrets() {
  return (
    <>
      <HomeSection className="w-full rounded-lg bg-teal-950/25 flex items-center justify-center flex-col py-8 h-[230px] mb-3">
        <h1 className="text-xl text-center uppercase font-light text-neutral-400 px-3 opacity-85">
        ...
        <LinkButton
          to="/login"
          className={
            "mt-5 text-lg sm:w-[200px] w-[180px] bg-red-950 text-center py-3"
          }
        >
          Login
        </LinkButton>
